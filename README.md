# Solidity Quest - An Educational Game for Solidity Enthusiasts

![Chat Application](/about-img.webp)
...
## Vision
The potential of **Solidity Quest** extends beyond just a game. We envision this system being utilized for:
...
## Supported Networks
**Solidity Quest** supports the following networks:
- Ethereum Sepolia.
- Polygon Amoy.
---
...
### Byte2 Learning Lab:
- Any number between `0x0001` and `0xFFFF` can be entered in the `_biggerNum` input box. 
